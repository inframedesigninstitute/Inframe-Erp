...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#fff", marginTop: 3, paddingRight:30 },
  title: { fontSize: 22, fontWeight: "700", textAlign: "center", marginVertical: 16, paddingRight:30,alignSelf:"center" },
  row: {
    flexDirection: "row",
    ...
    borderColor: "#eee",
    borderRadius: 10,
    marginBottom: 12, paddingRight:30, 
  },
