...
// Corrected imports
import StudentWebApp from "./src/StudentDashboard/App";
...
const styles = StyleSheet.create({
  roleSelection: { flex: 1, justifyContent: "center", alignItems: "center", height: "100%", backgroundColor: "#eef5fb" },
  title: { fontSize: 24, fontWeight: "bold", marginBottom: 20 },
  button: { backgroundColor: "#4a90e2", paddingVertical: 12, paddingHorizontal: 25, borderRadius: 8, marginVertical: 8 },
